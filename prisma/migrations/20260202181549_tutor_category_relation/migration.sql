...
-- CreateEnum
CREATE TYPE "BookingStatus" AS ENUM ('PENDING', 'CONFIRMED', 'COMPLETED', 'CANCELLED', 'ONGOING');
...
-- AddForeignKey
ALTER TABLE "_CategoryToTutor" ADD CONSTRAINT "_CategoryToTutor_B_fkey" FOREIGN KEY ("B") REFERENCES "Tutor"("id") ON DELETE CASCADE ON UPDATE CASCADE;
